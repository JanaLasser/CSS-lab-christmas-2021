...
ratio_df$ndays<-as.integer(rownames(ratio_df))
model_before<-lm(ratio~date,data = ratio_df[ratio_df$date<'2020-01-01',])
coeff_before<-coefficients(model_before)
...
{
  sentiment_data<-read.csv(paste0("/home/anatale/Documents/PhD/Christmas paper/2021/data/sentiment/unzipped/sentiment_language-",lang[i],"_emoji-🤌_2019-01-01-to-2021-11-28.csv"))
